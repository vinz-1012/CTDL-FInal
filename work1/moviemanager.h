...
public:
    MovieManager() {
        try {
            ...
            cout << RED << "Loi khi khoi tao MovieManager: " << e.what() << RESET << endl;
        }
    }
    ...
    void displayMovies() {
        try {
            ...
            cout << RED << "Loi khi hien thi danh sach phim: " << e.what() << RESET << endl;
        }
    }
    ...
    Movie* selectMovie() {
        try {
            ...
            cout << RED << "Loi khi chon phim: " << e.what() << RESET << endl;
        }
        return nullptr;
    }
    ...
    int selectShowtime(Movie* m) {
        try {
            ...
            cout << RED << "Loi khi chon suat chieu: " << e.what() << RESET << endl;
            return -1;
        }
    }
    ...
    Theater* getTheater(Movie* m, int showIndex) {
        try {
            ...
            cout << RED << "Loi khi lay phong chieu: " << e.what() << RESET << endl;
            return nullptr;
        }
    }
    ...
    Movie* getMovie(int index) {
        try {
            ...
            cout << RED << "Loi khi lay phim: " << e.what() << RESET << endl;
            return nullptr;
        }
    }
    ...
    void addMovie() {
        try {
            ...
            cout << RED << "Loi khi them phim: " << e.what() << RESET << endl;
        }
    }
    ...
    void editMovie() {
        try {
            ...
            cout << RED << "Loi khi sua phim: " << e.what() << RESET << endl;
        }
    }
    ...
    void deleteMovie() {
        try {
            ...
            cout << RED << "Loi khi xoa phim: " << e.what() << RESET << endl;
        }
    }
